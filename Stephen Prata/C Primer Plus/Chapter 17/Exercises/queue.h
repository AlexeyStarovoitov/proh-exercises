...
//typedef int Item; //for listing_17_8.c

typedef struct item //for listing_17_8.c
{
...
//postcondition: return True if queue is full, else False
bool QueueIsFull(const Queue * pq);

//operation: check if queue is empty
//precondition: pq points to previously initialized queue
//postcondition: return True if queue is empty, else False
bool QueueIsEmpty(const Queue * pq);

//operation: determine the number of items in queue
//precondition: pq points to previously initialized queue
...
/*
  postcondition: if queue is not empty, item at head of
				...
				begin with, queue is unchanged and
